...
public class Robot extends TimedRobot {
  ...
  SwerveDriveTrainConstants drivetrain = new SwerveDriveTrainConstants()
                              .withPigeon2Id(1)
                              .withCANbusName("Fred");
  ...
  /**
   * Note: WPI's coordinate system is Y forward, X to the left
   *       so make sure all locations are with respect to this coordinate system
   * 
   * This particular drive base is 22" x 22"
   */
  SwerveModuleConstants frontRight = new SwerveModuleConstants()
                                        .withDriveMotorId(1)
                                        .withSteerMotorId(0)
                                        .withCANcoderId(0)
  ...
  SwerveModuleConstants frontLeft = new SwerveModuleConstants()
                                        .withDriveMotorId(3)
                                        .withSteerMotorId(2)
                                        .withCANcoderId(1)
                                        ...
                                        .withSteerMotorGains(steerGains)
                                        .withDriveMotorGains(driveGains);
  SwerveModuleConstants backRight = new SwerveModuleConstants()
                                        .withDriveMotorId(5)
                                        .withSteerMotorId(4)
                                        .withCANcoderId(2)
                                        ...
                                        .withSteerMotorGains(steerGains)
                                        .withDriveMotorGains(driveGains);
  SwerveModuleConstants backLeft = new SwerveModuleConstants()
                                        .withDriveMotorId(7)
                                        .withSteerMotorId(6)
                                        .withCANcoderId(3)
  ...
  CTRSwerveDrivetrain m_drivetrain = new CTRSwerveDrivetrain(drivetrain, frontLeft, frontRight, backLeft, backRight);

  XboxController m_joystick = new XboxController(0);

  CANdleConstants frontCandle = new CANdleConstants()
                                      .withId(2)
                                      .withLocationX(1)
                                      .withLocationY(0);
  CANdleConstants rightCandle = new CANdleConstants()
                                      .withId(1)
                                      .withLocationX(0)
                                      .withLocationY(-1);
  CANdleConstants leftCandle = new CANdleConstants()
                                      .withId(4)
                                      .withLocationX(0)
                                      .withLocationY(1);
  CANdleConstants backCandle = new CANdleConstants()
                                      .withId(3)
                                      .withLocationX(-1)
                                      .withLocationY(0);
  ...
  CANdleManager m_candleManager = new CANdleManager("Fred", posY, posX, negY, negX, frontCandle, leftCandle, rightCandle, backCandle);
